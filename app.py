...
def obtener_stock_full():
    conn = conectar_db()
    # Mantenemos tu query original pero sumando el campo codigo
    query = """
    ...
    # Agrupamos respetando tu lógica original + el Código
    ...
    if stock_df.empty:
        ...
        if foto:
            with st.spinner("Procesando imagen..."):
                ...
                if codigo_leido:
                    # Buscamos match por código exacto o nombre
...
with tab3:
    if not stock_df.empty:
        ...
        # Mantenemos tu lógica de suma agrupada para el análisis
